...
int main() {
    ...
    world.add(make_shared<sphere>(point3(-1.0, 0.0, -1.0), 0.5, material_left)); //玻璃球的外表面
    world.add(make_shared<sphere>(point3(-1.0, 0.0, -1.0), -0.4, material_left)); //玻璃球的内表面 用的负的法线向量
